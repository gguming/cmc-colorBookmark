...
class GetColorListDataManager{
    func getColors(delegate: HomeViewController) {
        let header: HTTPHeaders = ["x-access-token" : "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjUsImlhdCI6MTYzNjcwNTg1MSwiZXhwIjoxNjY4MjQxODUxLCJzdWIiOiJ1c2VyVEIifQ.UOdLnN41IxgkUOzEZUcTLPwKzUAAuIHwOgfgZ-ID3mg"]
