//
//  NickNameMiniCodeViewController.swift
//  ColorBookMark
//
//  Created by 김지훈 on 2021/12/15.
//
...
class NickNameMiniCodeViewController: BaseViewController,UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    @IBOutlet weak var NickNameMiniCodeCollectionview: UICollectionView!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        NickNameMiniCodeCollectionview.delegate = self
        NickNameMiniCodeCollectionview.dataSource = self
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = NickNameMiniCodeCollectionview.dequeueReusableCell(withReuseIdentifier: "NickNameMiniCodeCollectionViewCell", for: indexPath) as! NickNameMiniCodeCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let cellWidth = NickNameMiniCodeCollectionview.frame.width/3 - 6
        let cellHeight = cellWidth * 1/2.5
        return CGSize(width: cellWidth, height: cellHeight)
    }
}

extension NickNameMiniCodeViewController {
    func passwordEnd() {
